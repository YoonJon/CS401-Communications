...
`DataManager` will create the entire directory if absent, but you won't be able to login or register without `data/server_data/authorized_ids/authorized_users.txt`
